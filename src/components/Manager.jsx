            ...
            <div className='my-8 container mx-auto max-w-5xl min-w-fit bg-cyan-200 rounded p-0.5'>
                ...
                <div className="text-white flex flex-col gap-4 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 p-6 rounded">
                    ...
                    <div className="button flex justify-center">
                        <button className='flex justify-center gap-3 min-w-2/5 max-w-4/5 hover:cursor-pointer  bg-gradient-to-r from-cyan-500 to-cyan-600 hover:bg-gradient-to-r hover:from-cyan-600 hover:to-cyan-700 text-white font-bold py-2 px-4 rounded rounded-4xl' type="submit">
